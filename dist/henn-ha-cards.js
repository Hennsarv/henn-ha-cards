...
class oldHennStonehengeCard extends HTMLElement {
    setConfig(config) {
        ...
        // siin oleks vaja teha series merge, et kui on value_entity, 
        // siis see oleks esimene seeria ja ülejäänud tuleks configist
        ...
        // siin nopime parameetrist konffi selliselt, et seeriad ja valueentity jäävad välja
        // sest need lähevad seeriate alla ja iga seeria peab ise määrama, millist entityt ta kasutab
        ...
        this.config = {
            ...
            // gradient, bar, line fill - seeriatele vaikimisi väärtused
            gradient: {
                color: "orange",
            ...
            // ticks ja label on root tasemel - need ei kuulu seeriate juurde
            ticks: {
                show: true,
                tight: false,
        ...
        delete this.config.value_entity; // value_entity peab olema seerias, kui on vaja
        delete this.config.series; // series on meil tõstetud omaette kollektsiooni


        this.rootConfig = {
            label: this.config.label,
            ticks: this.config.ticks,
            lower: this.config.lower, // root hoiab vt comment allpool
            upper: this.config.upper,
            bucketing: this.config.bucketing
        };
        // lower ja upper graafiku rööpad - kui emmal kummal on show true, siis joonistatakse,
        // muul juhul sisaldavad nad vaikimisi väärtusi, 
        // kui seerial on emmal kummal show true, siis joonistatakse ja vaikimisi väärtused võetakse rootCOnfigust
        ...
        //     // samuti jäävad välja muud root tasemele singleton omadused
        //     ...this.config,
        //     value_entity, // defaault väärtust ei ole - igal seerial peab oma olema
        //     label, // label on ainult root tasemel
        //     ticks, // numbrilaud on ainult root tasemel
        //     lower, // lower ja upper võtavad vaikimisi väärtused rootConfigust, kui seerial pole oma määratud
        //     upper,
        //     bucketing, // bucketing on kõigil seeriatel sama - selle alusel ka numbrilaud
        // };

        const { value_entity, label, ticks, lower, upper, bucketing, ...defConfig } = this.config;
        this.defConfig = defConfig;
        // siin on seeriatele ühised vaikimisi väärtused, mida nad saavad kasutada, kui neil endal pole määratud
